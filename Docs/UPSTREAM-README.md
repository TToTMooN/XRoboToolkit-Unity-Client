> Original XRoboToolkit PICO v1.1.1 documentation, retained as a reference.
> For this KILO branch, use the [current setup and build instructions](../KILO-FLOOR.md).
...
<div align="center">
  <img src="pc_service_connection.png" alt="pc_service_connection" width="387"/>
</div>

The main panel will display "WORKING" if connection is established.

<div align="center">
  <img src="pc_service_connected.png" alt="pc_service_connected" width="394"/>
</div>
...
![unable_to_sign.png](unable_to_sign.png)
...
![no_entitlement](no_entitlement.png)
